							...
							<div className="row g-4">
...

								{
									products.map((data) => (
										<>
											<div
												className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
												<div className="product-item">
													...
													<div className="text-center p-4">
														...
														<span className="text-primary me-1">${data.sale_price}</span>
													...
													<div className="d-flex border-top">
														<small className="w-50 text-center border-end py-2">
															<Link className="text-body" to={ `/${data.id}` }>
